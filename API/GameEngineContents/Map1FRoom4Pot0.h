...
class Map1FRoom4Pot0 : public GameEngineActor
{
public:
	...
	// delete Function
	Map1FRoom4Pot0(const Map1FRoom4Pot0& _Other) = delete;
	Map1FRoom4Pot0(Map1FRoom4Pot0&& _Other) noexcept = delete;
	Map1FRoom4Pot0& operator=(const Map1FRoom4Pot0& _Other) = delete;
	Map1FRoom4Pot0& operator=(Map1FRoom4Pot0&& _Other) noexcept = delete;
