...
Map1FRoom10Pot0::Map1FRoom10Pot0() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
	 PotPos_({ 2248.0f + 24.0f, 3268.0f + 24.0f }),
...
void Map1FRoom10Pot0::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom10Pot0::Render()
{

}

void Map1FRoom10Pot0::IdleStart()
{

}

void Map1FRoom10Pot0::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom10Pot0::InAirStart()
{
...
void Map1FRoom10Pot0::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom10Pot0::IdleUpdate()
{
...
void Map1FRoom10Pot0::CarriedUpdate()
{
	{
...
void Map1FRoom10Pot0::InAirUpdate()
{
...
void Map1FRoom10Pot0::DeathAnimationUpdate()
{
...
void Map1FRoom10Pot0::DeathUpdate()
{

}

void Map1FRoom10Pot0::PotStateChange(PotState _State)
{
...
void Map1FRoom10Pot0::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom10Pot0::CheckPickUpEnd()
{
