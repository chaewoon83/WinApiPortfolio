...
Map1FRoom1EnemyPopo2::Map1FRoom1EnemyPopo2()
	:PopoRenderer_(nullptr),
	 PopoCol_(nullptr),
	 PopoPos_({ 3104, 2375 + 4128 }),
	 IsInvincible_(false),
	 IsDeath_(false),
...
void Map1FRoom1EnemyPopo2::Start()
{
...
void Map1FRoom1EnemyPopo2::Update()
{
	PopoStateUpdate();
	BlinkUpdate();
}

void Map1FRoom1EnemyPopo2::Render()
{

}

void Map1FRoom1EnemyPopo2::GetDamaged()
{
...
void Map1FRoom1EnemyPopo2::BlinkUpdate()
{
...
void Map1FRoom1EnemyPopo2::IdleStart()
{
	//PopoRenderer_->ChangeAnimation("Idle");
	CurMoveFreq_ = MoveFreq_;
}

void Map1FRoom1EnemyPopo2::KnockbackedStart()
{
}

void Map1FRoom1EnemyPopo2::DeathStart()
{
	PopoRenderer_->SetAlpha(255);
...
void Map1FRoom1EnemyPopo2::IdleUpdate()
{
	GetDamaged();
...
void Map1FRoom1EnemyPopo2::KnockbackedUpdate()
{
...
void Map1FRoom1EnemyPopo2::DeathUpdate()
{
...
void Map1FRoom1EnemyPopo2::PopoChangeState(PopoState _State)
{
...
void Map1FRoom1EnemyPopo2::PopoStateUpdate()
{
...
bool Map1FRoom1EnemyPopo2::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
void Map1FRoom1EnemyPopo2::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 0, 1 };
