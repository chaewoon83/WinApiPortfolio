...
class Map1FRoom9EnemyBlueStalfos3 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom9EnemyBlueStalfos3();
	~Map1FRoom9EnemyBlueStalfos3();

	// delete Function
	Map1FRoom9EnemyBlueStalfos3(const Map1FRoom9EnemyBlueStalfos3& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos3(Map1FRoom9EnemyBlueStalfos3&& _Other) noexcept = delete;
	Map1FRoom9EnemyBlueStalfos3& operator=(const Map1FRoom9EnemyBlueStalfos3& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos3& operator=(Map1FRoom9EnemyBlueStalfos3&& _Other) noexcept = delete;
