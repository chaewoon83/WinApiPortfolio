...
Map1FRoom7Pot2::Map1FRoom7Pot2() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
	 PotPos_({ 488.0f + 24.0f, 3589.0f + 24.0f }),
...
void Map1FRoom7Pot2::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom7Pot2::Render()
{

}

void Map1FRoom7Pot2::IdleStart()
{

}

void Map1FRoom7Pot2::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom7Pot2::InAirStart()
{
...
void Map1FRoom7Pot2::DeathAnimationStart()
{
...
void Map1FRoom7Pot2::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom7Pot2::IdleUpdate()
{
...
void Map1FRoom7Pot2::CarriedUpdate()
{
	{
...
void Map1FRoom7Pot2::InAirUpdate()
{
...
void Map1FRoom7Pot2::DeathAnimationUpdate()
{
...
void Map1FRoom7Pot2::DeathUpdate()
{

}

void Map1FRoom7Pot2::PotStateChange(PotState _State)
{
...
void Map1FRoom7Pot2::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom7Pot2::CheckPickUpEnd()
{
