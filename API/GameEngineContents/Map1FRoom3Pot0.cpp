...
void Map1FRoom3Pot0::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom3Pot0::Render()
{

}

void Map1FRoom3Pot0::IdleStart()
{

}

void Map1FRoom3Pot0::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom3Pot0::InAirStart()
{
...
void Map1FRoom3Pot0::DeathAnimationStart()
{
...
void Map1FRoom3Pot0::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom3Pot0::IdleUpdate()
{
...
void Map1FRoom3Pot0::CarriedUpdate()
{
	{
...
void Map1FRoom3Pot0::InAirUpdate()
{
...
void Map1FRoom3Pot0::DeathAnimationUpdate()
{
...
void Map1FRoom3Pot0::DeathUpdate()
{

}

void Map1FRoom3Pot0::PotStateChange(PotState _State)
{
...
void Map1FRoom3Pot0::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom3Pot0::CheckPickUpEnd()
{
