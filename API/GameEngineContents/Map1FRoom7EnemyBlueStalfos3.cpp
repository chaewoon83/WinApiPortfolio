...
void Map1FRoom7EnemyBlueStalfos3::Start()
{
...
void Map1FRoom7EnemyBlueStalfos3::Update()
{
...
void Map1FRoom7EnemyBlueStalfos3::Render()
{

}

void Map1FRoom7EnemyBlueStalfos3::LookAroundRightStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos3::LookAroundLeftStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos3::LookAroundUpStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos3::LookAroundDownStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos3::WalkRightStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Walk");
}
void Map1FRoom7EnemyBlueStalfos3::WalkLeftStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Walk");
}
void Map1FRoom7EnemyBlueStalfos3::WalkUpStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Walk");
}
void Map1FRoom7EnemyBlueStalfos3::WalkDownStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos3::JumpRightStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Left");
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Jump");
}
void Map1FRoom7EnemyBlueStalfos3::JumpLeftStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Right");
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Jump");
}
void Map1FRoom7EnemyBlueStalfos3::JumpUpStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Down");
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Jump");
}
void Map1FRoom7EnemyBlueStalfos3::JumpDownStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Up");
...
void Map1FRoom7EnemyBlueStalfos3::KnockbackedStart()
{
}

void Map1FRoom7EnemyBlueStalfos3::DeathStart()
{
...
void Map1FRoom7EnemyBlueStalfos3::LookAroundUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos3::WalkUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (true == BlueStalfosJumpCol_->CollisionResult("Sword", ColList, CollisionType::Rect, CollisionType::Rect) ||
		true == BlueStalfosJumpCol_->CollisionResult("PotHitBox", ColList, CollisionType::Rect, CollisionType::Rect))
...
void Map1FRoom7EnemyBlueStalfos3::Action()
{

}

void Map1FRoom7EnemyBlueStalfos3::JumpUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos3::KnockbackedUpdate()
{
	GetDamaged();
...
void Map1FRoom7EnemyBlueStalfos3::DeathUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos3::BlueStalfosChangeState(BlueStalfosState _State)
{
...
void Map1FRoom7EnemyBlueStalfos3::BlueStalfosStateUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos3::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 1, 0 };
...
void Map1FRoom7EnemyBlueStalfos3::StopDirCheck()
{
...
void Map1FRoom7EnemyBlueStalfos3::JumpCheck()
{
}

void Map1FRoom7EnemyBlueStalfos3::GetDamaged()
{
...
void Map1FRoom7EnemyBlueStalfos3::JumpDirCheck(float4 _Dir)
{
...
bool Map1FRoom7EnemyBlueStalfos3::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
bool Map1FRoom7EnemyBlueStalfos3::MoveFunction()
{
	float4 CheckPos;
