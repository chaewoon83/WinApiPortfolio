...
Map1FRoom6EnemyBlueStalfos0::Map1FRoom6EnemyBlueStalfos0()
...
void Map1FRoom6EnemyBlueStalfos0::Start()
{
...
void Map1FRoom6EnemyBlueStalfos0::Update()
{
...
void Map1FRoom6EnemyBlueStalfos0::Render()
{

}

void Map1FRoom6EnemyBlueStalfos0::LookAroundRightStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom6EnemyBlueStalfos0::LookAroundLeftStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom6EnemyBlueStalfos0::LookAroundUpStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom6EnemyBlueStalfos0::LookAroundDownStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom6EnemyBlueStalfos0::WalkRightStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Walk");
}
void Map1FRoom6EnemyBlueStalfos0::WalkLeftStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Walk");
}
void Map1FRoom6EnemyBlueStalfos0::WalkUpStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Walk");
}
void Map1FRoom6EnemyBlueStalfos0::WalkDownStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom6EnemyBlueStalfos0::JumpRightStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Left");
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Jump");
}
void Map1FRoom6EnemyBlueStalfos0::JumpLeftStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Right");
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Jump");
}
void Map1FRoom6EnemyBlueStalfos0::JumpUpStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Down");
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Jump");
}
void Map1FRoom6EnemyBlueStalfos0::JumpDownStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Up");
...
void Map1FRoom6EnemyBlueStalfos0::KnockbackedStart()
{
	GameEngineSound::SoundPlayOneShot("enemyhit.mp3");
}

void Map1FRoom6EnemyBlueStalfos0::DeathStart()
{
...
void Map1FRoom6EnemyBlueStalfos0::LookAroundUpdate()
{
...
void Map1FRoom6EnemyBlueStalfos0::WalkUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (true == BlueStalfosJumpCol_->CollisionResult("Sword", ColList, CollisionType::Rect, CollisionType::Rect))
	{
	...
	float time = GameEngineTime::GetDeltaTime(TimeScale_);
...
void Map1FRoom6EnemyBlueStalfos0::Action()
{

}

void Map1FRoom6EnemyBlueStalfos0::JumpUpdate()
{
	...
	EnemyGlobalFunction::KnockBackMoveFunction(TimeScale_, JumpSpeed_, KnockbackDir_, BlueStalfosMoveCol_, this, PlayerLink::MapCarryColImage_, 32.0f, 14.0f, 64.0f);
...
void Map1FRoom6EnemyBlueStalfos0::KnockbackedUpdate()
{
	GetDamagedBySword();
...
void Map1FRoom6EnemyBlueStalfos0::DeathUpdate()
{
...
void Map1FRoom6EnemyBlueStalfos0::BlueStalfosChangeState(BlueStalfosState _State)
{
...
void Map1FRoom6EnemyBlueStalfos0::BlueStalfosStateUpdate()
{
...
void Map1FRoom6EnemyBlueStalfos0::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 1, 0 };
...
void Map1FRoom6EnemyBlueStalfos0::StopDirCheck()
{
...
void Map1FRoom6EnemyBlueStalfos0::JumpCheck()
{
}

void Map1FRoom6EnemyBlueStalfos0::GetDamagedBySword()
{
...
void Map1FRoom6EnemyBlueStalfos0::GetDamagedByPot()
{
...
void Map1FRoom6EnemyBlueStalfos0::JumpDirCheck(float4 _Dir)
{
...
bool Map1FRoom6EnemyBlueStalfos0::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
bool Map1FRoom6EnemyBlueStalfos0::MoveFunction()
{
	float4 CheckPos;
	...
	//SetMove(MoveDir * GameEngineTime::GetDeltaTime(0) * Speed_);
	{
		...
		if (Black != ColorNextTopRight &&
			...
			Black != ColorNextBot)
		{
			if (false == BlueStalfosMoveCol_->NextPostCollisionCheck("Block", NextRealPos))
			{
