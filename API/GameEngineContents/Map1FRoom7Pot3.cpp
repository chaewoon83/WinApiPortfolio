...
Map1FRoom7Pot3::Map1FRoom7Pot3() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
	 PotPos_({ 168.0f + 24.0f, 3876.0f + 24.0f }),
...
void Map1FRoom7Pot3::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom7Pot3::Render()
{

}

void Map1FRoom7Pot3::IdleStart()
{

}

void Map1FRoom7Pot3::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom7Pot3::InAirStart()
{
...
void Map1FRoom7Pot3::DeathAnimationStart()
{
...
void Map1FRoom7Pot3::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom7Pot3::IdleUpdate()
{
...
void Map1FRoom7Pot3::CarriedUpdate()
{
	{
...
void Map1FRoom7Pot3::InAirUpdate()
{
...
void Map1FRoom7Pot3::DeathAnimationUpdate()
{
...
void Map1FRoom7Pot3::DeathUpdate()
{

}

void Map1FRoom7Pot3::PotStateChange(PotState _State)
{
...
void Map1FRoom7Pot3::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom7Pot3::CheckPickUpEnd()
{
