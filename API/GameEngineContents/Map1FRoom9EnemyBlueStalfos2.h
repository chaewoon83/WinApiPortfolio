...
class Map1FRoom9EnemyBlueStalfos2 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom9EnemyBlueStalfos2();
	~Map1FRoom9EnemyBlueStalfos2();

	// delete Function
	Map1FRoom9EnemyBlueStalfos2(const Map1FRoom9EnemyBlueStalfos2& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos2(Map1FRoom9EnemyBlueStalfos2&& _Other) noexcept = delete;
	Map1FRoom9EnemyBlueStalfos2& operator=(const Map1FRoom9EnemyBlueStalfos2& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos2& operator=(Map1FRoom9EnemyBlueStalfos2&& _Other) noexcept = delete;
