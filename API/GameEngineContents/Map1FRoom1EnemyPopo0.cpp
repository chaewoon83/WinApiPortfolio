...
void Map1FRoom1EnemyPopo0::Start()
{
...
void Map1FRoom1EnemyPopo0::GetDamaged()
{
...
void Map1FRoom1EnemyPopo0::KnockbackedStart()
{
}
...
void Map1FRoom1EnemyPopo0::PopoChangeState(PopoState _State)
{
...
void Map1FRoom1EnemyPopo0::PopoStateUpdate()
{
...
bool Map1FRoom1EnemyPopo0::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
void Map1FRoom1EnemyPopo0::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 0, 1 };
