...
void Map1FRoom10EnemyBlueStalfos0::Update()
{
...
void Map1FRoom10EnemyBlueStalfos0::Render()
{

}

void Map1FRoom10EnemyBlueStalfos0::LookAroundRightStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom10EnemyBlueStalfos0::LookAroundLeftStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom10EnemyBlueStalfos0::LookAroundUpStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom10EnemyBlueStalfos0::LookAroundDownStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom10EnemyBlueStalfos0::WalkRightStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Walk");
}
void Map1FRoom10EnemyBlueStalfos0::WalkLeftStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Walk");
}
void Map1FRoom10EnemyBlueStalfos0::WalkUpStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Walk");
}
void Map1FRoom10EnemyBlueStalfos0::WalkDownStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom10EnemyBlueStalfos0::JumpRightStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Left");
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Jump");
}
void Map1FRoom10EnemyBlueStalfos0::JumpLeftStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Right");
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Jump");
}
void Map1FRoom10EnemyBlueStalfos0::JumpUpStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Down");
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Jump");
}
void Map1FRoom10EnemyBlueStalfos0::JumpDownStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Up");
...
void Map1FRoom10EnemyBlueStalfos0::KnockbackedStart()
{
	GameEngineSound::SoundPlayOneShot("enemyhit.mp3");
}

void Map1FRoom10EnemyBlueStalfos0::DeathStart()
{
...
void Map1FRoom10EnemyBlueStalfos0::LookAroundUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (PlayerStairsState::Bot == PlayerLink::GetPlayerStairsState())
	{
...
void Map1FRoom10EnemyBlueStalfos0::WalkUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (PlayerStairsState::Bot == PlayerLink::GetPlayerStairsState())
	{
...
void Map1FRoom10EnemyBlueStalfos0::Action()
{

}

void Map1FRoom10EnemyBlueStalfos0::JumpUpdate()
{
	...
	EnemyGlobalFunction::KnockBackMoveFunction(TimeScale_, JumpSpeed_, KnockbackDir_, BlueStalfosMoveCol_, this, PlayerLink::MapCarryColImage_2_B1F_, 32.0f, 14.0f, 64.0f);
...
void Map1FRoom10EnemyBlueStalfos0::KnockbackedUpdate()
{
	GetDamaged();
	CurKnockbackTime_ += GameEngineTime::GetDeltaTime(TimeScale_);
	int White = RGB(255, 255, 255);

	if (true == PosAndColorCheck(White, PlayerLink::MapCarryColImage_2_B1F_))
	{
		EnemyGlobalFunction::KnockBackMoveFunction(TimeScale_, KnockBackSpeed_, KnockbackDir_, BlueStalfosMoveCol_, this, PlayerLink::MapCarryColImage_2_B1F_, 32.0f, 14.0f, 64.0f);
	}
...
void Map1FRoom10EnemyBlueStalfos0::DeathUpdate()
{
...
void Map1FRoom10EnemyBlueStalfos0::BlueStalfosChangeState(BlueStalfosState _State)
{
...
void Map1FRoom10EnemyBlueStalfos0::BlueStalfosStateUpdate()
{
...
void Map1FRoom10EnemyBlueStalfos0::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 1, 0 };
...
void Map1FRoom10EnemyBlueStalfos0::StopDirCheck()
{
...
void Map1FRoom10EnemyBlueStalfos0::JumpCheck()
{
}

void Map1FRoom10EnemyBlueStalfos0::GetDamaged()
{
	...
	if (false == IsInvincible_ && false == IsDeath_ && PlayerStairsState::Bot == PlayerLink::GetPlayerStairsState())
	{
		std::vector<GameEngineCollision*> ColList;
...
void Map1FRoom10EnemyBlueStalfos0::JumpDirCheck(float4 _Dir)
{
...
bool Map1FRoom10EnemyBlueStalfos0::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
bool Map1FRoom10EnemyBlueStalfos0::MoveFunction()
{
	float4 CheckPos;
	...
	//SetMove(MoveDir * GameEngineTime::GetDeltaTime(0) * Speed_);
	{
		...
		int ColorNextTopRight = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosTopRight);
		int ColorNextTopLeft = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosTopLeft);
		int ColorNextBotRight = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosBotRight);
		int ColorNextBotLeft = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosBotLeft);
		int ColorNextRight = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosRight);
		int ColorNextLeft = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosLeft);
		int ColorNextTop = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosTop);
		int ColorNextBot = PlayerLink::MapCarryColImage_2_B1F_->GetImagePixel(CheckPosBot);
