...
class Map1FRoom9EnemyBlueStalfos1 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom9EnemyBlueStalfos1();
	~Map1FRoom9EnemyBlueStalfos1();

	// delete Function
	Map1FRoom9EnemyBlueStalfos1(const Map1FRoom9EnemyBlueStalfos1& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos1(Map1FRoom9EnemyBlueStalfos1&& _Other) noexcept = delete;
	Map1FRoom9EnemyBlueStalfos1& operator=(const Map1FRoom9EnemyBlueStalfos1& _Other) = delete;
	Map1FRoom9EnemyBlueStalfos1& operator=(Map1FRoom9EnemyBlueStalfos1&& _Other) noexcept = delete;
