...
Map1FRoom3EnemyPopo0::Map1FRoom3EnemyPopo0()
...
void Map1FRoom3EnemyPopo0::Start()
{
...
void Map1FRoom3EnemyPopo0::Update()
{
	PopoStateUpdate();
...
void Map1FRoom3EnemyPopo0::Render()
{

}

void Map1FRoom3EnemyPopo0::GetDamaged()
{
...
void Map1FRoom3EnemyPopo0::IdleStart()
{
	//PopoRenderer_->ChangeAnimation("Idle");
	CurMoveFreq_ = MoveFreq_;
}

void Map1FRoom3EnemyPopo0::KnockbackedStart()
{
}

void Map1FRoom3EnemyPopo0::DeathStart()
{
...
void Map1FRoom3EnemyPopo0::IdleUpdate()
{
	GetDamaged();
...
void Map1FRoom3EnemyPopo0::KnockbackedUpdate()
{
...
void Map1FRoom3EnemyPopo0::DeathUpdate()
{
...
void Map1FRoom3EnemyPopo0::PopoChangeState(PopoState _State)
{
...
void Map1FRoom3EnemyPopo0::PopoStateUpdate()
{
...
bool Map1FRoom3EnemyPopo0::PosAndColorCheck(int _Color, GameEngineImage* _Image, float4 _Pos)
{
...
void Map1FRoom3EnemyPopo0::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 0, 1 };
