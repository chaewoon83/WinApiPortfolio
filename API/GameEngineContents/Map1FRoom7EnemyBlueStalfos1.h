...
class Map1FRoom7EnemyBlueStalfos1 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom7EnemyBlueStalfos1();
	~Map1FRoom7EnemyBlueStalfos1();

	// delete Function
	Map1FRoom7EnemyBlueStalfos1(const Map1FRoom7EnemyBlueStalfos1& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos1(Map1FRoom7EnemyBlueStalfos1&& _Other) noexcept = delete;
	Map1FRoom7EnemyBlueStalfos1& operator=(const Map1FRoom7EnemyBlueStalfos1& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos1& operator=(Map1FRoom7EnemyBlueStalfos1&& _Other) noexcept = delete;
	bool GetIsDeath()
	{
		return IsDeath_;
	}
