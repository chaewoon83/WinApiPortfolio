...
void Zelda::TotalImageCut()
{
	...
	ImageCutter("Charge_Attack_Right.bmp", 12, 1);
	ImageCutter("Charge_Attack_Left.bmp", 12, 1);
	ImageCutter("Charge_Attack_Up.bmp", 12, 1);
	ImageCutter("Charge_Attack_Down.bmp", 12, 1);
