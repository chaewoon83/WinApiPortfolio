...
void Map1FRoom7EnemyBlueStalfos2::Start()
{
...
void Map1FRoom7EnemyBlueStalfos2::Update()
{
...
void Map1FRoom7EnemyBlueStalfos2::Render()
{

}

void Map1FRoom7EnemyBlueStalfos2::LookAroundRightStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos2::LookAroundLeftStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos2::LookAroundUpStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos2::LookAroundDownStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos2::WalkRightStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Walk");
}
void Map1FRoom7EnemyBlueStalfos2::WalkLeftStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Walk");
}
void Map1FRoom7EnemyBlueStalfos2::WalkUpStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Walk");
}
void Map1FRoom7EnemyBlueStalfos2::WalkDownStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos2::JumpRightStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Left");
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Jump");
}
void Map1FRoom7EnemyBlueStalfos2::JumpLeftStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Right");
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Jump");
}
void Map1FRoom7EnemyBlueStalfos2::JumpUpStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Down");
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Jump");
}
void Map1FRoom7EnemyBlueStalfos2::JumpDownStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Up");
...
void Map1FRoom7EnemyBlueStalfos2::KnockbackedStart()
{
}

void Map1FRoom7EnemyBlueStalfos2::DeathStart()
{
...
void Map1FRoom7EnemyBlueStalfos2::LookAroundUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos2::WalkUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (true == BlueStalfosJumpCol_->CollisionResult("Sword", ColList, CollisionType::Rect, CollisionType::Rect) ||
		true == BlueStalfosJumpCol_->CollisionResult("PotHitBox", ColList, CollisionType::Rect, CollisionType::Rect))
...
void Map1FRoom7EnemyBlueStalfos2::Action()
{

}

void Map1FRoom7EnemyBlueStalfos2::JumpUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos2::KnockbackedUpdate()
{
	GetDamaged();
...
void Map1FRoom7EnemyBlueStalfos2::DeathUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos2::BlueStalfosChangeState(BlueStalfosState _State)
{
...
void Map1FRoom7EnemyBlueStalfos2::BlueStalfosStateUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos2::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 1, 0 };
...
void Map1FRoom7EnemyBlueStalfos2::StopDirCheck()
{
...
void Map1FRoom7EnemyBlueStalfos2::JumpCheck()
{
}

void Map1FRoom7EnemyBlueStalfos2::GetDamaged()
{
...
void Map1FRoom7EnemyBlueStalfos2::JumpDirCheck(float4 _Dir)
{
...
bool Map1FRoom7EnemyBlueStalfos2::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
bool Map1FRoom7EnemyBlueStalfos2::MoveFunction()
{
	float4 CheckPos;
