...
class Map1FRoom6EnemyBlueStalfos0 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom6EnemyBlueStalfos0();
	~Map1FRoom6EnemyBlueStalfos0();

	// delete Function
	Map1FRoom6EnemyBlueStalfos0(const Map1FRoom6EnemyBlueStalfos0& _Other) = delete;
	Map1FRoom6EnemyBlueStalfos0(Map1FRoom6EnemyBlueStalfos0&& _Other) noexcept = delete;
	Map1FRoom6EnemyBlueStalfos0& operator=(const Map1FRoom6EnemyBlueStalfos0& _Other) = delete;
	Map1FRoom6EnemyBlueStalfos0& operator=(Map1FRoom6EnemyBlueStalfos0&& _Other) noexcept = delete;
