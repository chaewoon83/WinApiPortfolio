...
Map1FRoom10Pot0B1F::Map1FRoom10Pot0B1F() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
...
void Map1FRoom10Pot0B1F::Start()
{
	...
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::B1FBELOWPLAYER));

}
 
void Map1FRoom10Pot0B1F::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom10Pot0B1F::Render()
{

}

void Map1FRoom10Pot0B1F::IdleStart()
{

}

void Map1FRoom10Pot0B1F::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::B1FABOVEPLAYER));
}

void Map1FRoom10Pot0B1F::InAirStart()
{
...
void Map1FRoom10Pot0B1F::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom10Pot0B1F::IdleUpdate()
{
...
void Map1FRoom10Pot0B1F::CarriedUpdate()
{
	{
...
void Map1FRoom10Pot0B1F::InAirUpdate()
{
...
void Map1FRoom10Pot0B1F::DeathAnimationUpdate()
{
...
void Map1FRoom10Pot0B1F::DeathUpdate()
{

}

void Map1FRoom10Pot0B1F::PotStateChange(PotState _State)
{
...
void Map1FRoom10Pot0B1F::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom10Pot0B1F::CheckPickUpEnd()
{
