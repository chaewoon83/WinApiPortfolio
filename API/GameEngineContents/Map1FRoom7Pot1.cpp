...
Map1FRoom7Pot1::Map1FRoom7Pot1() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
	 PotPos_({ 807.0f + 24.0f, 3300.0f + 24.0f }),
...
void Map1FRoom7Pot1::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom7Pot1::Render()
{

}

void Map1FRoom7Pot1::IdleStart()
{

}

void Map1FRoom7Pot1::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom7Pot1::InAirStart()
{
...
void Map1FRoom7Pot1::DeathAnimationStart()
{
...
void Map1FRoom7Pot1::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom7Pot1::IdleUpdate()
{
...
void Map1FRoom7Pot1::CarriedUpdate()
{
	{
...
void Map1FRoom7Pot1::InAirUpdate()
{
...
void Map1FRoom7Pot1::DeathAnimationUpdate()
{
...
void Map1FRoom7Pot1::DeathUpdate()
{

}

void Map1FRoom7Pot1::PotStateChange(PotState _State)
{
...
void Map1FRoom7Pot1::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom7Pot1::CheckPickUpEnd()
{
