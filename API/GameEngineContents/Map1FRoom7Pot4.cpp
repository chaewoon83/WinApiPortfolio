...
Map1FRoom7Pot4::Map1FRoom7Pot4() 
	:Renderer_(nullptr),
	 BlockCol_(nullptr),
	 PickUpCol_(nullptr),
	 PotHitBox_(nullptr),
	 PotPos_({ 808.0f + 24.0f, 3876.0f + 24.0f }),
...
void Map1FRoom7Pot4::Update()
{
	Reset();
	PotStateUpdate();
}
void Map1FRoom7Pot4::Render()
{

}

void Map1FRoom7Pot4::IdleStart()
{

}

void Map1FRoom7Pot4::CarriedStart()
{
	Renderer_->SetOrder(static_cast<int>(PlayLevelOrder::ABOVEPLAYER));
}

void Map1FRoom7Pot4::InAirStart()
{
...
void Map1FRoom7Pot4::DeathAnimationStart()
{
...
void Map1FRoom7Pot4::DeathStart()
{
	IsInRoom_ = false;
	Renderer_->Off();
}

void Map1FRoom7Pot4::IdleUpdate()
{
...
void Map1FRoom7Pot4::CarriedUpdate()
{
	{
...
void Map1FRoom7Pot4::InAirUpdate()
{
...
void Map1FRoom7Pot4::DeathAnimationUpdate()
{
...
void Map1FRoom7Pot4::DeathUpdate()
{

}

void Map1FRoom7Pot4::PotStateChange(PotState _State)
{
...
void Map1FRoom7Pot4::PotStateUpdate()
{
	switch (CurPotState_)
	{
	case PotState::Idle:
...
bool Map1FRoom7Pot4::CheckPickUpEnd()
{
