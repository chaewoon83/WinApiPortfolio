...
class Map1FRoom10EnemyBlueStalfos0 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom10EnemyBlueStalfos0();
	~Map1FRoom10EnemyBlueStalfos0();

	// delete Function
	Map1FRoom10EnemyBlueStalfos0(const Map1FRoom10EnemyBlueStalfos0& _Other) = delete;
	Map1FRoom10EnemyBlueStalfos0(Map1FRoom10EnemyBlueStalfos0&& _Other) noexcept = delete;
