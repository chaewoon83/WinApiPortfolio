...
Map1FRoom2EnemyPopo0::Map1FRoom2EnemyPopo0()
...
void Map1FRoom2EnemyPopo0::Start()
{
...
void Map1FRoom2EnemyPopo0::Update()
{
	PopoStateUpdate();
...
void Map1FRoom2EnemyPopo0::Render()
{

}

void Map1FRoom2EnemyPopo0::GetDamaged()
{
...
void Map1FRoom2EnemyPopo0::IdleStart()
{
	//PopoRenderer_->ChangeAnimation("Idle");
	CurMoveFreq_ = MoveFreq_;
}

void Map1FRoom2EnemyPopo0::KnockbackedStart()
{
}

void Map1FRoom2EnemyPopo0::DeathStart()
{
	PopoMoveCol_->Death();
...
void Map1FRoom2EnemyPopo0::IdleUpdate()
{
	GetDamaged();
...
void Map1FRoom2EnemyPopo0::KnockbackedUpdate()
{
...
void Map1FRoom2EnemyPopo0::DeathUpdate()
{
...
void Map1FRoom2EnemyPopo0::PopoChangeState(PopoState _State)
{
...
void Map1FRoom2EnemyPopo0::PopoStateUpdate()
{
...
bool Map1FRoom2EnemyPopo0::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
void Map1FRoom2EnemyPopo0::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 0, 1 };
