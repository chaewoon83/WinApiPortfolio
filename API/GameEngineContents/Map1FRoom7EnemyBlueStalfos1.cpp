...
void Map1FRoom7EnemyBlueStalfos1::Start()
{
...
void Map1FRoom7EnemyBlueStalfos1::Update()
{
...
void Map1FRoom7EnemyBlueStalfos1::Render()
{

}

void Map1FRoom7EnemyBlueStalfos1::LookAroundRightStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos1::LookAroundLeftStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos1::LookAroundUpStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos1::LookAroundDownStart()
{
	StopDirCheck();
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos1::WalkRightStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Walk");
}
void Map1FRoom7EnemyBlueStalfos1::WalkLeftStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Walk");
}
void Map1FRoom7EnemyBlueStalfos1::WalkUpStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Walk");
}
void Map1FRoom7EnemyBlueStalfos1::WalkDownStart()
{
	BlueStalfosHeadRenderer_->SetPivot({ 0, -28 });
	BlueStalfosBodyRenderer_->SetPivot({ 0, 24 });
...
void Map1FRoom7EnemyBlueStalfos1::JumpRightStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Left");
	BlueStalfosBodyRenderer_->ChangeAnimation("Right_Jump");
}
void Map1FRoom7EnemyBlueStalfos1::JumpLeftStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Right");
	BlueStalfosBodyRenderer_->ChangeAnimation("Left_Jump");
}
void Map1FRoom7EnemyBlueStalfos1::JumpUpStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Down");
	BlueStalfosBodyRenderer_->ChangeAnimation("Up_Jump");
}
void Map1FRoom7EnemyBlueStalfos1::JumpDownStart()
{
	CurJumpVerSpeed_ = 0.0f;
	BlueStalfosHeadRenderer_->ChangeAnimation("Up");
...
void Map1FRoom7EnemyBlueStalfos1::KnockbackedStart()
{
}

void Map1FRoom7EnemyBlueStalfos1::DeathStart()
{
...
void Map1FRoom7EnemyBlueStalfos1::LookAroundUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos1::WalkUpdate()
{
	std::vector<GameEngineCollision*> ColList;
	if (true == BlueStalfosJumpCol_->CollisionResult("Sword", ColList, CollisionType::Rect, CollisionType::Rect) ||
		true == BlueStalfosJumpCol_->CollisionResult("PotHitBox", ColList, CollisionType::Rect, CollisionType::Rect))
...
void Map1FRoom7EnemyBlueStalfos1::Action()
{

}

void Map1FRoom7EnemyBlueStalfos1::JumpUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos1::KnockbackedUpdate()
{
	GetDamaged();
...
void Map1FRoom7EnemyBlueStalfos1::DeathUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos1::BlueStalfosChangeState(BlueStalfosState _State)
{
...
void Map1FRoom7EnemyBlueStalfos1::BlueStalfosStateUpdate()
{
...
void Map1FRoom7EnemyBlueStalfos1::MoveDirCheck(int _RandomInt)
{
	if (1 == _RandomInt)
	{
		MoveDir_ = float4{ 1, 0 };
...
void Map1FRoom7EnemyBlueStalfos1::StopDirCheck()
{
...
void Map1FRoom7EnemyBlueStalfos1::JumpCheck()
{
}

void Map1FRoom7EnemyBlueStalfos1::GetDamaged()
{
...
void Map1FRoom7EnemyBlueStalfos1::JumpDirCheck(float4 _Dir)
{
...
bool Map1FRoom7EnemyBlueStalfos1::PosAndColorCheck(int _Color, GameEngineImage* _Image)
{
...
bool Map1FRoom7EnemyBlueStalfos1::MoveFunction()
{
	float4 CheckPos;
