...
class Map1FRoom7EnemyBlueStalfos3 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom7EnemyBlueStalfos3();
	~Map1FRoom7EnemyBlueStalfos3();

	// delete Function
	Map1FRoom7EnemyBlueStalfos3(const Map1FRoom7EnemyBlueStalfos3& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos3(Map1FRoom7EnemyBlueStalfos3&& _Other) noexcept = delete;
	Map1FRoom7EnemyBlueStalfos3& operator=(const Map1FRoom7EnemyBlueStalfos3& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos3& operator=(Map1FRoom7EnemyBlueStalfos3&& _Other) noexcept = delete;
	bool GetIsDeath()
	{
		return IsDeath_;
	}
