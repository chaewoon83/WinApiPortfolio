...
class Map1FRoom7EnemyBlueStalfos2 : public GameEngineActor
{
public:
	// constrcuter destructer
	Map1FRoom7EnemyBlueStalfos2();
	~Map1FRoom7EnemyBlueStalfos2();

	// delete Function
	Map1FRoom7EnemyBlueStalfos2(const Map1FRoom7EnemyBlueStalfos2& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos2(Map1FRoom7EnemyBlueStalfos2&& _Other) noexcept = delete;
	Map1FRoom7EnemyBlueStalfos2& operator=(const Map1FRoom7EnemyBlueStalfos2& _Other) = delete;
	Map1FRoom7EnemyBlueStalfos2& operator=(Map1FRoom7EnemyBlueStalfos2&& _Other) noexcept = delete;
	bool GetIsDeath()
	{
		return IsDeath_;
	}
