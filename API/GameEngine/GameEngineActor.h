...
public:
	...
	GameEngineRenderer* CreateRendererToScale(const std::string& _Image, const float4& _PivotScale, RenderPivot _PivotType = RenderPivot::CENTER, const float4& _PivotPos = { 0,0 });
	void Rendering();
private:
	//딴데서 사용하지 말것
